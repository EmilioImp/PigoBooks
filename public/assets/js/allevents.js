$(document).ready(function(){
    ...
    function createPages(response){
        ...
        for( i; i < arrayLength; i++){
            $(".card-columns").append('<div class="card"><a href="author.html?parameter=' + jsArray[i].authorID + '" class="card-link"><img class="card-img" src="' + jsArray[i].image_path + '" alt="Card img cap"><div class="card-body"><h5 class="card-title">' + jsArray[i].name + " - " + jsArray[i].date + " - " + jsArray[i].time + '</h5></div></a></div>');
        }
